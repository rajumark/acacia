...
class DslCodeGenerator {
    ...
    private fun generateFileForPackage(
        ...
        val fileName = packageName.substringAfterLast(".") + "Modifiers"
     ...
     * Preserves package structure (forward slashes) which are valid in Kotlin type notation.
     */
    private fun sanitizeTypeName(typeName: String): String {
        return typeName.replace("$", "_dollar_")
                 .replace("<", "_lt_")
                 .replace(">", "_gt_")
                 .replace("(", "_")
                 .replace(")", "_")
     ...
     * Preserves dots which are valid in parameter names.
     */
